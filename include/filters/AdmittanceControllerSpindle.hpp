/** AdmittanceControllersSpindle.hpp
 *
...
#ifndef ADMITTANCECONTROLLERSSPINDLE_HPP
#define ADMITTANCECONTROLLERSSPINDLE_HPP
...
namespace FILTERS
{
  ...
  : public RTT::TaskContext
    ...
    public:
        ...
        AdmittanceControllersSpindle(const string& name);
        ~AdmittanceControllersSpindle();
