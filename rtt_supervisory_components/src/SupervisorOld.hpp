...
#ifndef SUPERVISOROLD_HPP_
#define SUPERVISOROLD_HPP_
...
namespace SUPERVISORY
{
    ...
    : public RTT::TaskContext
      ...
      public:
        ...
        SupervisorOld(const std::string& name);
        /** Destructeur par défaut */
        virtual ~SupervisorOld();
